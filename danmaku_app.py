...
#
# .exe additions edited on May 23, 2019
#
...
# Fonts
FONT_SM = pygame.font.Font(current_path  + '/assets/fonts/whiterabbit.ttf', 24)
FONT_MD = pygame.font.Font(current_path  + '/assets/fonts/whiterabbit.ttf', 32)
FONT_LG = pygame.font.Font(current_path  + '/assets/fonts/whiterabbit.ttf', 64)
FONT_XL = pygame.font.Font(current_path  + '/assets/fonts/Kamikaze.ttf', 76)


# Images
splash_img = pygame.image.load(current_path  + '/assets/images/Splash/splash_screen.png').convert()
splash_img_resample = pygame.transform.scale(splash_img, (1280, 720))
background_img = pygame.image.load(current_path  + '/assets/images/Background/windows_doom.png').convert()
background_img_resample = pygame.transform.scale(background_img, (1280, 720))

ship_img = pygame.image.load(current_path  + '/assets/images/player.png').convert_alpha()
laser_img = pygame.image.load(current_path  + '/assets/images/laserRed.png').convert_alpha()
shield_img = pygame.image.load(current_path  + '/assets/images/shield.png').convert_alpha()

virus_img = pygame.image.load(current_path  + '/assets/images/virus.png').convert_alpha()
virus2_img = pygame.image.load(current_path  + '/assets/images/virus2.png').convert_alpha()

virus_img2 = pygame.image.load(current_path  + '/assets/images/virus_lv2.png').convert_alpha()
virus2_img2 = pygame.image.load(current_path  + '/assets/images/virus2_lv2.png').convert_alpha()

virus_img3 = pygame.image.load(current_path  + '/assets/images/virus_lv3.png').convert_alpha()
virus2_img3 = pygame.image.load(current_path  + '/assets/images/virus2_lv3.png').convert_alpha()

final_boss_img = pygame.image.load(current_path  + '/assets/images/boss.png').convert_alpha()
final_boss_img_scaled = pygame.transform.scale(final_boss_img, (448, 384))

bomb_img = pygame.image.load(current_path  + '/assets/images/laserGreen.png').convert_alpha()
powerup_img = pygame.image.load(current_path  + '/assets/images/health_powerup.png').convert_alpha()
laser_speed_powerup_img = pygame.image.load(current_path  + '/assets/images/laser_speed_powerup.png').convert_alpha()
speed_powerup_img = pygame.image.load(current_path  + '/assets/images/speed_powerup.png').convert_alpha()


# Sounds
BOMB_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/bomb.ogg')
END_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/end.ogg')
EXPLOSION_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/explosion.ogg')
LASER_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/laser.ogg')
WIN_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/win.ogg')
ERROR_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/Windows XP Critical Stop.ogg')
POWERUP_SFX = pygame.mixer.Sound(current_path  + '/assets/sounds/powerup.ogg')

EXPLOSION_SFX.set_volume(0.1)


# Music
FINAL_BOSS = pygame.mixer.music.load(current_path  + '/assets/music/Eye of the Storm_Hybrid Orchestral.ogg')
